...
let nameColumn = new Column<BootcBuildInfo, string>('Image', {
  width: '2fr',
...
let tagColumn = new Column<BootcBuildInfo, string>('Tag', {
  renderMapping: object => object.tag,
  renderer: SimpleColumn,
  comparator: (a, b) => a.tag.localeCompare(b.tag),
});

let progressColumn = new Column<BootcBuildInfo>('Progress', {
  width: '2fr',
  overflow: true,
...
let locationColumn = new Column<BootcBuildInfo, string>('Folder', {
  renderMapping: object => object.folder,
  renderer: SimpleColumn,
