...
import { faRocket, faArrowCircleDown, faCube, faWandMagicSparkles } from '@fortawesome/free-solid-svg-icons';
...
<DashboardPage>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div class="flex flex-col p-4 rounded-md bg-[var(--pd-content-card-carousel-card-bg)] hover:bg-[var(--pd-content-card-carousel-card-hover-bg)]">
        <div class="flex items-center gap-3 mb-3">
          ...
          <div>
            <h3 class="font-semibold text-[var(--pd-invert-content-card-text)]">Create a Bootable Container</h3>
            <p class="text-xs text-[var(--pd-invert-content-card-text)] opacity-70">Recommended for new users</p>
          </div>
        </div>
        <p class="text-sm text-[var(--pd-invert-content-card-text)] grow">
          Step-by-step wizard to select a base image, customize your Containerfile, and build a bootable disk image.
        </p>
        <Button on:click={goToOnboarding} icon={faWandMagicSparkles} class="self-start mt-3">Interactive Build</Button>
      </div>
  ...
  <div class="space-y-3">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <button
        type="button"
        class="flex flex-col p-4 rounded-md bg-[var(--pd-content-card-carousel-card-bg)] hover:bg-[var(--pd-content-card-carousel-card-hover-bg)] text-left"
