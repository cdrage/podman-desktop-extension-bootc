...
**Assessed**: May 19, 2026 at 10:13 AM
...
| Metric | Value |
|--------|-------|
| **Overall Score** | **56.3/100** 🥉 **Bronze** ([Tier Definitions](https://agentready.dev/attributes.html#tier-system)) |
...
3. **Standard Project Layouts** (Tier 1) - +5.0 points potential
   - Organize code into standard directories
4. **CI Quality Gates** (Tier 1) - +5.0 points potential
...
![T2](https://img.shields.io/badge/T2-.gitignore_Completeness_36--100-red) **.gitignore Completeness** ❌ 36/100
<details>
<summary>📝 Remediation Steps</summary>

**Measured**: 4/11 patterns (Threshold: ≥70% of language-specific patterns)

**Evidence**:
- .gitignore found (96 bytes)
- Pattern coverage: 4/11 (36%)
...
![T4](https://img.shields.io/badge/T4-Progressive_Disclosure_10--100-red) **Progressive Disclosure** ❌ 10/100
<details>
<summary>📝 Remediation Steps</summary>
...
**Evidence**:
- Root CLAUDE.md is 122 lines (good: <150)
...
- **Assessment Date**: May 19, 2026 at 10:13 AM
